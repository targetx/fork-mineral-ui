...
export const checkboxTheme: CheckboxThemeFn = (baseTheme) =>
  mapComponentThemes(
    ...
    },
    {
      name: 'Checkbox',
      theme: {
        CheckboxControl_backgroundColor_checked:
          baseTheme.checkbox_backgroundColor_checked,
        CheckboxControl_backgroundColor_checkedHover:
          baseTheme.checkbox_backgroundColor_checkedHover,
        CheckboxControl_borderColor: baseTheme.checkbox_borderColor,
        CheckboxControl_borderColor_checked:
          baseTheme.checkbox_borderColor_checked,
        CheckboxControl_borderColor_checkedHover:
          baseTheme.checkbox_borderColor_checkedHover,
